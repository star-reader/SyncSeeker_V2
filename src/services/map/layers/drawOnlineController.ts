...
const CONTROLLER_COLORS: Record<ControllerType, { fill: string; line: string }> = {
    CTR: { fill: 'rgba(191, 219, 254, 0.15)', line: 'rgba(59, 130, 246, 0.8)' },   // 蓝色
    APP: { fill: 'rgba(252, 231, 243, 0.15)', line: 'rgba(236, 72, 153, 0.8)' },   // 粉色
    FSS: { fill: 'rgba(221, 214, 254, 0.15)', line: 'rgba(139, 92, 246, 0.8)' },   // 紫色
